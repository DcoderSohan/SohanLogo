      ...
      <div className="text-center">
        ...
        >
          {showCancel && (
            <button
              onClick={onClose}
              className="flex-1 px-4 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold rounded-lg transition-all"
            >
              {cancelText}
            </button>
          )}
          <button
            ...
            className={`flex-1 px-4 py-2.5 ${config.buttonClass} text-white font-semibold rounded-lg transition-all transform hover:scale-105 active:scale-95`}
          >
            {confirmText}
          </button>
        </motion.div>
